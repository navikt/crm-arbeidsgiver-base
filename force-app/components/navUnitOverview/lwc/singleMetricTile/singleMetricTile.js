...
export default class SingleMetricTile extends LightningElement {
    ...
    @api metricValue2; // value is a number representing the most recent reading for the metric available.
    @api metricUnit2; // identifies the magnitude of the thing the metric is measuring
    ...
    setValues() {
        ...
        this._metricValue2 = this.metricValue2;
        this._metricUnit2 = this.metricUnit2;
    ...
    get isMultinumber() {
        return this._metricValue2 !== undefined && this._metricValue2 !== null;
    }
