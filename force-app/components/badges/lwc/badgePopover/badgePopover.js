 ...
 */
export default class BadgePopover extends NavigationMixin(LightningElement) {
    ...
    handleLinkClick(event) {
        ...
        this.hasButtonFocus = false;
        try {
            console.log('handlePopoverLinkClick: ' + this.pageref);
            this[NavigationMixin.Navigate](this.pageref);
        } catch (error) {
            this.handleError('Error handling popover link click', error);
        }
    }
